...
ITEM_POOL = {
    ...
    '泛娱乐直播': [
        ...
        '呱呱社区', '抱抱直播', 'bilibili直播', 'BIGO LIVE', '嗨秀秀场','乐嗨秀场', '么么直播', '九秀直播'
    ],
    '电竞体育直播': [
        '熊猫直播', '斗鱼直播', '虎牙直播', '企鹅直播', '企鹅电竞', '熊猫直播', '战旗直播', '狮吼直播', '触手直播', '龙珠直播','章鱼TV'
    ],
    '小视频': [
        '美拍', '快手', '火山小视频', '抖音', '淘宝直播', '梨视频', '开眼视频', '秒拍', '映兔视频', 'V电影', '魔力盒视频','快视频',
